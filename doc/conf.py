# -*- coding: utf-8 -*-
#
# JSON Schema Validator documentation build configuration file, created by
...
copyright = u'2010, 2011 Linaro Limited; 2016 Zygmunt Krynicki'
...
htmlhelp_basename = 'JSONSchemaValidatorDoc'
...
latex_documents = [
  ('index', 'json-schema-validator.tex', u'JSON Schema Validator Documentation',
